...
function sendOrderToTelegram() {
    ...
    let message = `🆕 *YANGI BUYURTMA* #${orderId}\n\n`;
    message += `👤 *Mijoz:* ${customerName}\n`;
    message += `📱 *Telegram:* ${telegramUsername.startsWith('@') ? telegramUsername : '@' + telegramUsername}\n`;
    message += `🎮 *PUBG ID:* ${gameId}\n`;
    message += `🏷 *Mahsulot turi:* ${productType === 'pubg' ? 'PUBG UC' : 'Telegram Premium/Stars'}\n`;
    message += `💰 *Jami summa:* ${totalAmount.toLocaleString()} UZS\n\n`;
    message += `📦 *Mahsulotlar:*\n`;
